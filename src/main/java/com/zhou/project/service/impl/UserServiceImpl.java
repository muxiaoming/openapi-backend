...
import com.zhou.project.mapper.UserMapper;
...
import static com.zhou.project.constant.UserConstant.ADMIN_ROLE;
import static com.zhou.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            // 唯一即可,DigestUtils.md5DigestAsHex() 与 DigestUtil.md5Hex() 作用应该一样
